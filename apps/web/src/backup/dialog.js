...
exports.ExampleDialog = exports.DialogDescription = exports.DialogTitle = exports.DialogFooter = exports.DialogHeader = exports.DialogContent = exports.DialogTrigger = exports.DialogClose = exports.DialogOverlay = exports.DialogPortal = exports.Dialog = void 0;
...
var ExampleDialog = function () {
    ...
    return ((0, jsx_runtime_1.jsxs)(Dialog, { open: open, onOpenChange: setOpen, children: [(0, jsx_runtime_1.jsx)(DialogTrigger, { asChild: true, children: (0, jsx_runtime_1.jsx)("button", { className: "bg-accent py-2 px-4 text-white rounded-sm", children: "Open Dialog" }) }), (0, jsx_runtime_1.jsxs)(DialogContent, { children: [(0, jsx_runtime_1.jsxs)(DialogHeader, { children: [(0, jsx_runtime_1.jsx)(DialogTitle, { children: "Dialog Title" }), (0, jsx_runtime_1.jsx)(DialogDescription, { children: "This is a dialog description." })] }), (0, jsx_runtime_1.jsx)("div", { className: "p-4", children: (0, jsx_runtime_1.jsx)("p", { children: "This is a dialog content." }) }), (0, jsx_runtime_1.jsx)(DialogFooter, { children: (0, jsx_runtime_1.jsx)("button", { className: "bg-accent py-2 px-4 text-white rounded-sm", onClick: function () { return setOpen(false); }, children: "Close" }) })] })] }));
};
exports.ExampleDialog = ExampleDialog;
